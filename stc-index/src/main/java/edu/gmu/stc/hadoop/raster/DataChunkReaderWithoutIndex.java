 ...
 */
public class DataChunkReaderWithoutIndex extends RecordReader<DataChunk, ArrayFloatSerializer> {
  private static final Log LOG = LogFactory.getLog(DataChunkReaderWithoutIndex.class);
